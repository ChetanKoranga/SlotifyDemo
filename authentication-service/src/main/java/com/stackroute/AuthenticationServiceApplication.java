...
=======
    ...
    private ApiInfo apiDetails() {
        return new ApiInfoBuilder().title("Authentication API").description("This is api for Authentication Purposes").version("0.0.1").contact(new Contact("Parth", " ", "mailtoparth21@gmail.com")).build();
    }
